...
## Project Structure
    ...
    ├── justatestscreen_dev_87555  # Django project configurations
...
1. Clone this repo and `cd justatestscreen_dev_87555`
...
2. Clone this repo and `cd justatestscreen_dev_87555`
